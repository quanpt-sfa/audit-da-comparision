...
def main() -> None:
    ...
    exchange_coverage = read_table(output, "cfs_exchange_sample_coverage")
    ...
    covid_coverage = read_table(output, "cfs_covid_sample_coverage")
    ...
    add_table(lines, "Exchange sample coverage", exchange_coverage, "No exchange coverage table was produced.")
    ...
    add_table(lines, "COVID-regime sample coverage", covid_coverage, "No COVID coverage table was produced.")
    ...
    lines += [
        ...
        "5. Any directional conclusion must be supported by the primary configured window and remain qualitatively stable under at least one alternative window.",
    ]
