...
from audit_da.next_diagnostics import component_placebo_tables, write_tables


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run PAT/CFO component-specific placebos and independent-anchor tests"
    )
    ...
    tables = component_placebo_tables(baseline, panel, config["component_placebo"])
